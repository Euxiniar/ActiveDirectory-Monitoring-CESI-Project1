...
Pour configurer l'Active Directory principal, importer le script suivant sur le serveur S-GRP-AD01  puis lancer le en tant q'administrateur:
...
-----------------------------------------------------------------------------------------
Pour le serveur REPLICA de l'Active Directory principal, importer le script suivant sur le serveur S-GRP-AD02 puis lancer le en tant q'administrateur::
